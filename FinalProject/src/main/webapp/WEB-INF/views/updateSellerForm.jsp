								...
								<div class="row margin">
									<div class="input-field col s12">
										...
										<i class="material-icons prefix">vpn_key</i> <input
											...
											type="password" value="${member.password}" /> <label
											for="password">暗証番号</label>
									</div>
								</div>
										...
										<div class="row margin">
											<div class="input-field col s12">
												...
												<i class="material-icons prefix">account_circle</i> <input
													id="name" name="name" class="input_size" type="text"
													value="${member.name}" /> <label for="username">お名前</label>
											</div>
										</div>
										...
										<div class="row margin">
											<div class="input-field col s12">
												...
												<i class="material-icons prefix">assignment_ind</i> <input
													...
													type="text" value="${member.nameKana}" /> <label
													for="name_kana">ふりがな</label>
											</div>
										</div>
										...
										<div class="row margin">
											<div class="input-field col s12">
												...
												<i class="material-icons prefix">account_balance</i> <input
													...
													value="${member.address}" /> <label for="address">お住まいの都道府県</label>
											</div>
										</div>
										<div class="input-field col s12">
