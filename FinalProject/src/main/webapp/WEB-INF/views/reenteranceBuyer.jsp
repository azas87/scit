	...
	<body style="background:url(./resources/img/bg.png) repeat;">
		<div class="container">
			<div class="row main">
				...
				<input type="hidden" value="buyer" id="grade">
					<form class="form-horizontal" method="post" action="reenterance" >
						...
						<div class="form-group">
							...
							<div id="result" data="default" style="color: red; font-size: 15px; font-weight: bolder;"></div>
						...
						<div class="form-group ">
							<button class="btn btn-primary btn-lg btn-block login-button" onclick="return check()">会員再登録</button>
