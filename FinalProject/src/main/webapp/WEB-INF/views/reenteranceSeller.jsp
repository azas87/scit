...
<input type="hidden" value="seller" id="grade">
		  ...
		  <div class="col s12 z-depth-4 card-panel">
		    <div class="login-form">
		      <div class="row">
		        ...
		        <div class="input-field col s12 center">
			          <h2>会員再登録のすすめ</h2>
			          <p class="center">メールアドレスを入力してください。</p>
			      ...
			      <div class="row margin">
			        <div class="input-field col s12">
			      	...
			      	<div id="result" data="default" style="color: red; font-size: 35px; font-weight: bolder;"></div>
			      <div class="input-field col s12">
