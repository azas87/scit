...
<body>
	...
	<div class="review" >
   	...
   	<br>
		<span>コメントをどうぞ</span><br>
   	<textarea id="reviewComment" style="margin-top: 10px; margin-bottom: 5px;"></textarea><br>

	<div class="button" style="width:280;">
		<input type="button" value="登録" onclick="review()" style="float:right; ">
	</div>
	</body>
</html>
