		...
		<div class='panel panel-primary dialog-panel'　>
			...
			<div class='panel-body'>
				<form class='form-horizontal' role='form' action="newFishInfo">
					...
					<div class='form-group'>
						<label class='control-label col-md-2 col-md-offset-2'
							for='id_title'>カテゴリ</label>
						<div class='col-md-8'>
							<div class='col-md-2'>
								<div class='form-group internal'>
									<select id="fishCategoryNum" name="fishCategoryNum"
										class='form-control'>
					...
					<div class='form-group'>
						<label class='control-label col-md-2 col-md-offset-2'
							for='id_email'>旬</label>
						<div class='col-md-8'>
							<div class='col-md-2'>
								<div class='form-group internal'>
									<input type="text" class='form-control' id="seasonInfo"
										name="seasonInfo" />
								</div>
							</div>
						</div>
					...
					<div class='form-group'>
						<label class='control-label col-md-2 col-md-offset-2'
							for='id_comments'>基本情報</label>
						<div class='col-md-6'>
							<textarea class='form-control' id='fishInfo'
								placeholder='Additional comments1' cols="20" rows='20'
								name="fishInfo"></textarea>
						</div>
					</div>
					<div class='form-group'>
						...
						<div class='col-md-3'>
							<button class='btn-lg btn-danger'
								style="float: right; background-color: #3aa9d5; border-color: #3aa9d5; float: right;"
