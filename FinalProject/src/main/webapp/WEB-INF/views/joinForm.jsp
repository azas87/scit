								...
								<div class="login-form">
									...
									<div class="row margin">
										<div class="input-field col s12">
											...
											<i class="material-icons prefix">account_box</i> <input
												id="id" name="id" class="input_size" type="text" /> <label
												for="usernid">ニックネーム</label>
										</div>
									</div>
									...
									<div class="row margin">
										<div class="input-field col s12">
											...
											<i class="material-icons prefix">vpn_key</i> <input
												id="password" name="password" class="input_size"
												type="password" /> <label for="password">暗証番号</label>
										</div>
									</div>
									...
									<div class="row margin">
										<div class="input-field col s12">
											<!-- <i class="mdi-action-lock-outline prefix"></i> -->
											<i class="material-icons prefix">vpn_key</i> <input
												id="userpwd2" name="userpwd2" class="input_size"
												type="password" /> <label for="password_a">暗証番号の再入力</label>
										</div>
									</div>
								</div>
									...
									<div class="row margin">
										<div class="input-field col s12">
											...
											<i class="material-icons prefix">account_balance</i> <input
												id="email" name="email" class="input_size" type="text" /> <label
												for="address">メールアドレス</label>
										</div>
									</div>
										...
										<div class="input-field col s12 center">
											...
											<div class="row margin">
												<div class="input-field col s12">
													...
													<i class="material-icons prefix">account_circle</i> <input
														id="name" name="name" class="input_size" type="text" /> <label
														for="username">お名前</label>
												</div>
											</div>
											...
											<div class="row margin">
												<div class="input-field col s12">
													...
													<i class="material-icons prefix">assignment_ind</i> <input
														id="nameKana" name="nameKana" class="input_size"
														type="text" /> <label for="name_kana">ふりがな</label>
												</div>
											</div>
											...
											<div class="row margin">
												<div class="input-field col s12">
													<!-- <i class="mdi-action-lock-outline prefix"></i> -->
													<i class="material-icons prefix">account_balance</i> <input
														id="address" name="address" class="input_size" type="text" />
											...
											<div class="input-field col s12">
												<button id="submit_btn"
													...
													onclick="return check()">会員登録</button>
											</div>
										</div>
									</div>
								</div>
