...
public class BuyList {
	...
	public BuyList(String buyNum, String fishName, String buyerId, Date registDate, Date uploadDate,
			Date deadline, int weight, String saleStatus, int price, String successSellerId, String buyListComment,
			String location) {
		super();
		this.buyNum = buyNum;
